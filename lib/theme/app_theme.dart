...
class AppTheme {
  ...
  // Natural Harvest Palette - Earth-toned colors optimized for outdoor mobile usage
  ...
  static const Color secondaryLight =
      Color(0xFF558B2F); // Lighter agricultural green
  ...
  static const Color accentLight = Color(0xFFFF8F00); // Warm orange
  ...
  static const Color accentDark = Color(0xFFFFCC02);
  ...
  /// Typography: Inter font family for contemporary agricultural marketplace credibility
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Headings: Inter (400, 500, 600) - Contemporary sans-serif with excellent mobile legibility
      ...
      // Body: Inter (400, 500) - Consistent font family for extended reading
      ...
      // Captions: Inter (400) - Smaller text for metadata and secondary information
  ...
  /// Data typography using JetBrains Mono for prices, quantities, and numerical data
  ...
  /// Custom colors for agricultural marketplace specific use cases
  ...
  /// Shadow elevation system - 2dp, 4dp, and 8dp shadows with 20% opacity
